...
This skill analyzes Markdown article structure, generates illustration prompts for each section, calls the Gemini API to batch-produce images, and inserts them into the document.
...
在所有提示词之前，必须先生成一个 STYLE INSTRUCTIONS 代码块，参考 references/style-guide.md 中的风格模板。
