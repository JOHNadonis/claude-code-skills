---
name: source-command-ecc-instinct-export
description: "Export instincts from project/global scope to a file"
---

# source-command-ecc-instinct-export

Use this skill when the user asks to run the migrated source command `ecc-instinct-export`.
