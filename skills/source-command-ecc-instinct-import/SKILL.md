---
name: source-command-ecc-instinct-import
description: "Import instincts from file or URL into project/global scope"
---

# source-command-ecc-instinct-import

Use this skill when the user asks to run the migrated source command `ecc-instinct-import`.
