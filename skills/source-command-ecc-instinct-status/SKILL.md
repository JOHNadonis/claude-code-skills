---
name: source-command-ecc-instinct-status
description: "Show learned instincts (project + global) with confidence"
---

# source-command-ecc-instinct-status

Use this skill when the user asks to run the migrated source command `ecc-instinct-status`.
