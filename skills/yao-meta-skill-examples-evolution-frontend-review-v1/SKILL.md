---
name: yao-meta-skill-examples-evolution-frontend-review-v1
...
2. Check accessibility, rendering safety, form behavior, loading states, and error states.
3. Report findings by severity with code references.
